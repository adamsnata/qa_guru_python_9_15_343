import allure
from metro_tests_suite.pages.catalog_page import Catalog


@allure.title('Catalog section')
def test_simple_catalog_section():
    ...
    with allure.step('Select the catalog position'):
